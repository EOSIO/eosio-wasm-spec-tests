...
const string wasm_str_start_3 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/start.3.wasm";
...
const string wasm_str_start_4 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/start.4.wasm";
...
const string wasm_str_start_5 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/start.5.wasm";
...
BOOST_DATA_TEST_CASE(start_5_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_start_5);
   tester.produce_block();
...
const string wasm_str_start_6 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/start.6.wasm";
...
BOOST_DATA_TEST_CASE(start_6_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_start_6);
   tester.produce_block();
