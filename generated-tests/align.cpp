...
const string wasm_str_align_0 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.0.wasm";
...
BOOST_DATA_TEST_CASE(align_0_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_0);
   tester.produce_block();
...
const string wasm_str_align_1 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.1.wasm";
...
BOOST_DATA_TEST_CASE(align_1_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_1);
   tester.produce_block();
...
const string wasm_str_align_10 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.10.wasm";
...
BOOST_DATA_TEST_CASE(align_10_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_10);
   tester.produce_block();
...
const string wasm_str_align_106 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.106.wasm";
...
const string wasm_str_align_107 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.107.wasm";
...
const string wasm_str_align_11 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.11.wasm";
...
BOOST_DATA_TEST_CASE(align_11_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_11);
   tester.produce_block();
...
const string wasm_str_align_12 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.12.wasm";
...
BOOST_DATA_TEST_CASE(align_12_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_12);
   tester.produce_block();
...
const string wasm_str_align_13 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.13.wasm";
...
BOOST_DATA_TEST_CASE(align_13_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_13);
   tester.produce_block();
...
const string wasm_str_align_14 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.14.wasm";
...
BOOST_DATA_TEST_CASE(align_14_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_14);
   tester.produce_block();
...
const string wasm_str_align_15 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.15.wasm";
...
BOOST_DATA_TEST_CASE(align_15_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_15);
   tester.produce_block();
...
const string wasm_str_align_16 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.16.wasm";
...
BOOST_DATA_TEST_CASE(align_16_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_16);
   tester.produce_block();
...
const string wasm_str_align_17 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.17.wasm";
...
BOOST_DATA_TEST_CASE(align_17_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_17);
   tester.produce_block();
...
const string wasm_str_align_18 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.18.wasm";
...
BOOST_DATA_TEST_CASE(align_18_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_18);
   tester.produce_block();
...
const string wasm_str_align_19 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.19.wasm";
...
BOOST_DATA_TEST_CASE(align_19_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_19);
   tester.produce_block();
...
const string wasm_str_align_2 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.2.wasm";
...
BOOST_DATA_TEST_CASE(align_2_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_2);
   tester.produce_block();
...
const string wasm_str_align_20 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.20.wasm";
...
BOOST_DATA_TEST_CASE(align_20_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_20);
   tester.produce_block();
...
const string wasm_str_align_21 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.21.wasm";
...
BOOST_DATA_TEST_CASE(align_21_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_21);
   tester.produce_block();
...
const string wasm_str_align_22 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.22.wasm";
...
BOOST_DATA_TEST_CASE(align_22_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_22);
   tester.produce_block();
...
const string wasm_str_align_3 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.3.wasm";
...
BOOST_DATA_TEST_CASE(align_3_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_3);
   tester.produce_block();
...
const string wasm_str_align_4 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.4.wasm";
...
BOOST_DATA_TEST_CASE(align_4_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_4);
   tester.produce_block();
...
const string wasm_str_align_5 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.5.wasm";
...
BOOST_DATA_TEST_CASE(align_5_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_5);
   tester.produce_block();
...
const string wasm_str_align_6 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.6.wasm";
...
BOOST_DATA_TEST_CASE(align_6_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_6);
   tester.produce_block();
...
const string wasm_str_align_7 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.7.wasm";
...
BOOST_DATA_TEST_CASE(align_7_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_7);
   tester.produce_block();
...
const string wasm_str_align_8 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.8.wasm";
...
BOOST_DATA_TEST_CASE(align_8_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_8);
   tester.produce_block();
...
const string wasm_str_align_9 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/align.9.wasm";
...
BOOST_DATA_TEST_CASE(align_9_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_align_9);
   tester.produce_block();
