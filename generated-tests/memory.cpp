...
const string wasm_str_memory_0 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/memory.0.wasm";
...
BOOST_DATA_TEST_CASE(memory_0_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_memory_0);
   tester.produce_block();
...
const string wasm_str_memory_1 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/memory.1.wasm";
...
BOOST_DATA_TEST_CASE(memory_1_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_memory_1);
   tester.produce_block();
...
const string wasm_str_memory_2 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/memory.2.wasm";
...
BOOST_DATA_TEST_CASE(memory_2_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_memory_2);
   tester.produce_block();
...
const string wasm_str_memory_25 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/memory.25.wasm";
...
const string wasm_str_memory_3 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/memory.3.wasm";
...
BOOST_DATA_TEST_CASE(memory_3_module, boost::unit_test::data::xrange(0,1), index) { try {
   ...
   tester.create_account( N(wasmtest) );
   tester.produce_block();
   tester.set_code(N(wasmtest), wasm_memory_3);
   tester.produce_block();
...
const string wasm_str_memory_6 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/memory.6.wasm";
...
const string wasm_str_memory_7 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/memory.7.wasm";
...
const string wasm_str_memory_8 = base_dir + "/eosio-wasm-spec-tests/generated-tests/wasms/memory.8.wasm";
